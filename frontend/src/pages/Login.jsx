        ...
        <form>
          <div className="flex flex-col font-montserrat">
            ...
            <input
              ...
              className="border-b-2 border-b-gray-300 outline-none hover:border-b-black focus:border-b-black"
              value={email}
              type="email"
            ...
            <div className="relative">
              <input
                ...
                className="w-full border-b-2 border-b-gray-300 outline-none hover:border-b-black focus:border-b-black"
                value={password}
            ...
            <div className="flex justify-center pt-5">
              <button
                ...
                className="text-white w-[50%] border-2 bg-[#2B5579] hover:bg-[#4ba3d3] rounded-full py-2 font-bold "
                type="submit"
              >
                Masuk
              </button>
            ...
            <div className="py-10 text-sm">
              <p>
                Belum punya akun?{" "}
                <a href="/register" class="underline hover:font-medium text-xs">
                  Daftar di sini!
                </a>
              </p>
            </div>
