...
export default function Notifikasi() {
  ...
  const [conditions] = useState(true);
                  ...
                  <div className="md:container md:mx-auto">
                    <div className="flex justify-center items-center h-screen">
                      <div className="mr-6 ml-[25%] w-[70%] mb-10 bg-white rounded-lg shadow-md p-8">
                        <p className="font-quicksand text-3xl font-bold mb-4 text-center">Belum Ada Notifikasi</p>
                        <p className="font-quicksand font-normal text-gray-600 text-lg text-center">Mohon maaf, notifikasi belum ada!</p>
                      </div>
                    </div>
                  </div>
                ) : (
