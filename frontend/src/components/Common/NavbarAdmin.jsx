  ...
  return (
    <nav className="fixed w-[20%] bg-main-blue-2 rounded-tl-0 rounded-tr-[70px] rounded-br-[70px] rounded-bl-0 h-auto">
      <div className="flex justify-center">
        <img
          className="w-[35%] mt-7"
          src={`${process.env.PUBLIC_URL}/logo_maneasy_2.png`}
          alt="Icon"
        />
      </div>
      <div className="p-5 ml-2 mt-3">
        <span className="font-quicksand font-semibold text-sm text-custom-white-2">
          MENU
        </span>
      </div>
      <ul className="mt-2">
        <li
          className={`mb-1 ml-5 rounded-40 ${
            isClickedAdmin
              ? "bg-custom-gradient text-white"
              : "text-custom-gray-2 hover:bg-custom-gradient text-white"
        ...
        >
          <a
            ...
            className="font-quicksand font-medium text-sm hover:text-white pr-4 flex items-center "
          >
            <img
              src={`${
                isClickedAdmin
                  ? process.env.PUBLIC_URL +
                    "/assets/kelola_admin_icon_active.svg"
                  : isHoveredAdmin
                  ? process.env.PUBLIC_URL +
                    "/assets/kelola_admin_icon_active.svg"
                  : process.env.PUBLIC_URL + "/assets/kelola_admin_icon.svg"
              }`}
        ...
        >
          <a
            href="/"
            id="home"
            onMouseOver={handleMouseOverMahasiswa}
            onMouseLeave={handleMouseLeaveMahasiswa}
            onClick={handleClickMahasiswa}
            className="font-quicksand font-medium text-sm hover:text-white pr-4 flex items-center "
          >
            <img
              src={`${
                isClickedMahasiswa
                  ? process.env.PUBLIC_URL +
                    "/assets/kelola_mhs_icon_active.svg"
                  : isHoveredMahasiswa
                  ? process.env.PUBLIC_URL +
                    "/assets/kelola_mhs_icon_active.svg"
                  : process.env.PUBLIC_URL + "/assets/kelola_mhs_icon.svg"
              }`}
              alt="kelola_admin_icon"
              className="ml-0"
            />
        ...
        >
          <a
            href="/"
            id="home"
            onMouseOver={handleMouseOverProfilDKM}
            onMouseLeave={handleMouseLeaveProfilDKM}
            onClick={handleClickProfilDKM}
            className="font-quicksand font-medium text-sm hover:text-white pr-4 flex items-center "
          >
            <img
              src={`${
                isClickedProfilDKM
                  ? process.env.PUBLIC_URL +
                    "/assets/profile_dkm_icon_active.svg"
                  : isHoveredProfilDKM
                  ? process.env.PUBLIC_URL +
                    "/assets/profile_dkm_icon_active.svg"
                  : process.env.PUBLIC_URL + "/assets/profile_dkm_icon.svg"
              }`}
              alt="kelola_admin_icon"
              className="ml-0"
            />
        ...
        <li
          className={`mt-3 mb-1 ml-5 rounded-40 ${
            isClickedInventories
              ? "bg-custom-gradient text-white"
              : "text-custom-gray-2 hover:bg-custom-gradient text-white"
          } hover:drop-shadow-xl items-center`}
        >
          ...
          >
            <img
              src={`${
                isClickedInventories
                  ? process.env.PUBLIC_URL + "/assets/sarpras_icon_active.svg"
                  : isHoveredInventories
                  ? process.env.PUBLIC_URL + "/assets/sarpras_icon_active.svg"
                  : process.env.PUBLIC_URL + "/assets/sarpras_icon.svg"
              }`}
      ...
      <ul className="mt-2">
        ...
        >
          <a
            ...
            id="home"
            onMouseOver={handleMouseOverNotif}
          ...
          >
            <img
              src={`${
                isClickedNotif
                  ? process.env.PUBLIC_URL +
                    "/assets/notification_icon_active.svg"
                  : isHoveredNotif
                  ? process.env.PUBLIC_URL +
                    "/assets/notification_icon_active.svg"
                  : process.env.PUBLIC_URL + "/assets/notification_icon.svg"
              }`}
              alt="Activity_icon"
              className="ml-0"
            />
        ...
        >
          <a
            href="/"
            id="home"
            onMouseOver={handleMouseOverKeluar}
            onMouseLeave={handleMouseLeaveKeluar}
            onClick={handleClickKeluar}
            className="font-quicksand font-medium text-sm hover:text-white pr-4 flex items-center "
          >
            <img
              src={`${
                isClickedKeluar
                  ? process.env.PUBLIC_URL + "/assets/signout_icon_active.svg"
                  : isHoveredKeluar
                  ? process.env.PUBLIC_URL + "/assets/signout_icon_active.svg"
                  : process.env.PUBLIC_URL + "/assets/signout_icon.svg"
              }`}
              alt="Signout_icon"
              className="ml-0"
            />
      ...
      >
        <div className=" flex bg-white p-3 m-8 rounded-[10px] shadow-md hover:drop-shadow-2xl bg-custom-gray-3">
          <div className="flex justify-center items-center" id="profile">
            <img
              className="w-[45px] "
              src={process.env.PUBLIC_URL + "/assets/admin_icon.svg"}
              alt=""
            />
          </div>
